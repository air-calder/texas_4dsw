...
foreach v in teachid syear district campus is_entrant event_time incoming_from_tx incoming_first_time incoming_alt_path incoming_experience incoming_adv_degree incoming_no_degree {
...
export delimited using "code/4DSW student teacher analysis/replication/output/tables/teacher_entrant_eventstudy.csv", replace
