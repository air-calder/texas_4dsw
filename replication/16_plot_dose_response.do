...
twoway ///
	...
	xlabel(1(1)`ngroups') ///
	xtitle("4DSW intensity group (1 = lowest, `ngroup' = highest)") ///
...
graph export "code/4DSW student teacher analysis/replication/output/figures/dose_response_stay_school.png", replace width(1400) height(900)